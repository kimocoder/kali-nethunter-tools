#!/bin/bash
# build-libxml2.sh - Build libxml2 for Android
...
SRC_DIR="$SCRIPT_DIR/../src/libxml2"
...
export PKG_CONFIG_PATH="$PREFIX/zlib/lib/pkgconfig:${PKG_CONFIG_PATH:-}"
...
log_cmd ./configure \
  ...
  LDFLAGS="$LDFLAGS -L$PREFIX/zlib/lib"
